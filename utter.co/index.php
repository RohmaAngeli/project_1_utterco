...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="index.php?page=daftar" class="book-a-table-btn scrollto d-none d-lg-flex" style="margin-right:-28%;">Daftar</a>
      <a href="index.php?page=masuk" class="book-a-table-btn scrollto d-none d-lg-flex" style="margin-right:-5%;">Masuk</a>
    </div>
  </header><!-- End Header -->
      ...
      if (isset($_GET['page'])){
        ...
        switch ($page) {
          ...
          case 'menu':
            ...
            break;
          case 'kontak':
            include "page_guest/page_kontak.php"; 
            break;
          case 'daftar':
