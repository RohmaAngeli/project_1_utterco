...
<br><br>
      ...
      <div class="row">
         ...
         <div class="col-4" style="padding:2% 0 5% 5%;">
            <img src="image_profile_view.php?username=<?php echo $_SESSION["username"]; ?>" alt="" width="230px" height="230px" style="background-color:#ffffff; border-radius:50%; box-shadow: 0 0 30px 5px #cda45e; border: 1px solid #000000; color:#000;">               
         </div>
         ...
         <div class="col-8">
            <div class="main" style="margin-top:4%; background-color:#cda45e; padding:40px; border-radius:20px; border: 3px solid #000000">
               ...
               <div class="text" style="color:#000; text-align:center; margin-top:3%; margin-bottom:3%; font-weight:bold;">"Money can't buy happiness? Lie! Money buys coffee, coffee makes you happy!"</div>
	            <div class="row">
                  <div class="col"><center><button style="width:100%; background-color:#48120E ; border-radius:20px; padding:10px; font-size:20px; cursor: pointer; letter-spacing:5px; color:white; font-weight:bold;" onMouseOver="this.style.backgroundColor='#AB3E16'" onMouseOut="this.style.backgroundColor='#48120E'">Edit Gambar</button></center></div>
      ...
      <div>
         <div>
            <div class="alert alert-info alert-dismissable" style="" data-aos="fade-left" >
         ...
         <div>
            <div class="main" style="background-color:#cda45e; padding:40px; border-radius:20px; border: 3px solid #000000">
               <table align='center'>
	            ...
	            <center><button style="width:70%; margin-top:3%; background-color:#48120E ; border-radius:20px; padding:10px; font-size:20px; cursor: pointer; letter-spacing:5px; color:white; font-weight:bold;" onMouseOver="this.style.backgroundColor='#AB3E16'" onMouseOut="this.style.backgroundColor='#48120E'">Edit Keterangan</button></center>
            </div>
         </div>
      </div>
      <?php
