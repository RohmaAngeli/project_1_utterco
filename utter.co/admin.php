    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="admin.php?page=manage_menu">Manage Menu</a></li>
          <li><a href="admin.php?page=manage_kontak">Manage Contact Us</a></li>
          <li><a href="admin.php?page=manage_user">Manage User</a></li>
          <li><a href="admin.php?page=profil">Profil</a></li>
      ...
      if (isset($_GET['page'])){
        ...
        switch ($page) {
          case 'beranda':
            ...
            break;
          case 'manage_menu':
            include "page_admin/page_manage_menu.php"; 
            break;
          case 'manage_kontak':
            include "page_admin/page_manage_kontak.php"; 
            break;
          case 'manage_user':
            include "page_admin/page_manage_user.php";
            break;
          case 'profil':
